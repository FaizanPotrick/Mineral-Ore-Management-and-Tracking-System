    ...
    <div class="flex justify-center items-center bg-yellow-50">
      ...
      >
        <div class="mb-4">
          ...
          <div class="text-gray-500 text-sm">Reset Your Password</div>
        </div>
        <form
          class="space-y-5 drop-shadow-md"
          @submit.prevent="useLoginStore().login_fn()"
        >
          <div class="space-y-2">
            ...
            <input
              ...
              v-model="useLoginStore().user_name"
              type="text"
          ...
          <div class="space-y-2">
            ...
            <input
              ...
              v-model="useLoginStore().password"
              autocomplete
              required
            />
          </div>
          <div class="space-y-2">
            <label class="text-sm font-medium"> Aadhaar Card </label>
            <input
              class="w-full content-center text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
              type="password"
