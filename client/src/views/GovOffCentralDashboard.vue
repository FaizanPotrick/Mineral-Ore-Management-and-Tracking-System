  ...
  <div class="flex flex-col gap-4 min-h-screen">
    <div class="flex gap-4 w-full min-h-[12vh] font-semibold">
      ...
      >
        ...
        <div class="text-xl">500000</div>
        <div>Number of active mines</div>
      </div>
      <div
      ...
      >
        ...
        <div class="text-xl">154500</div>
        <div>No Of Officers</div>
      </div>
    ...
    <div class="flex flex-col">
      <button class="btn bg-blue-200 p-5 font-bold">Officer Logs (IDEATION)</button>
