            ...
            <div class="w-full border rounded-xl overflow-hidden drop-shadow-md">
                <table class="w-full">
                    <thead class="border-b whitespace-nowrap bg-yellow-400">
                        <tr>
                            <th class="py-4">Lab Id</th>
                            <th class="py-4">Lab Name</th>
                            <th class="py-4">Manager Id</th>
                        </tr>
                    </thead>
                    <tbody class="whitespace-nowrap">
                        <tr :key="lab._id" v-for="lab in labs" class="text-center hover:bg-yellow-100/20 cursor-pointer"
                            @click="router.push(`/dashboard/labs/${lab._id}`)">
                            <td class="py-4">
                                <abbr style="text-decoration: none" :title="lab._id">
                                    ...{{ lab._id.slice(15) }}
                                </abbr>
                            </td>
                            <td class="py-4">
