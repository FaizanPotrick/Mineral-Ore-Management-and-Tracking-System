                            ...
                            <ul class="w-42 text-sm font-medium text-gray-900 bg-white ">
                                <li v-for="status in status" class="w-full rounded-t-lg ">
                                    <div class="flex items-center">
                                        <input type="radio" v-model="checked_list" v-bind:value="status"
                        ...
                        <div class="px-3">
                            ...
                            <ul class="w-35 text-sm font-medium text-gray-900 bg-white">
                                <li v-for="grade in grade" class="w-full rounded-t-lg">
                                    <div class="flex items-center">
                                        <input type="radio" v-model="checked_list" v-bind:value="grade"
                                            @keyup.enter="filterList()"
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
                ...
                <table class="w-full">
                    ...
                    <tbody class="font-normal text-gray-600 whitespace-nowrap">
                        <tr :key="mine._id" v-for="mine in mined_batches" class="text-center">
                            ...
                            " class="px-6 py-4">
                                <RouterLink :to="
                                    '/dashboard/mined_batches/' + mine._id + '/approve_mined_batch'
