    ...
    >
      <div class="flex justify-between items-center w-full">
        ...
        <button
          type="submit"
          @click="searchList()"
          class="text-white absolute right-5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2"
        >
          Search
        </button>
      </div>
