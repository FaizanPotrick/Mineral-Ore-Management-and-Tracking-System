...
<template>
    <div class="flex flex-col justify-between items-center max-h-screen min-h-screen bg-yellow-50">
        ...
        <div
            ...
            <form class="space-y-5 drop-shadow-md" @submit.prevent="useLoginStore().login_fn(router)">
                ...
                <div class="space-y-3">
                    ...
                    <button type="submit" :class="{ 'hover:bg-yellow-600/80': !useValidationStore().isButtonLoading }"
