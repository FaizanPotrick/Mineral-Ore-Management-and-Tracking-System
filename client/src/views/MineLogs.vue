...
<template>
  <div class="flex m- p-6">
    <h3 class="text-2xl font-medium text-gray-900 text-left">Mine Logs</h3>
    <div class="xl:w-96">
        ...
        <div class="overflow-hidden">
          <table class="table-auto min-w-full border-2 font-medium">
            ...
            <tbody>
              ...
              >
                <td
                  class="text-md text-gray-900 font-normal px-6 py-4 whitespace-nowrap"
                >
                  {{ mine.batch_id }}
                </td>
                <td
                ...
                <td
                  class="text-md text-gray-900 font-normal px-6 py-4 whitespace-nowrap"
                >
                  <a href="" class="text-blue-500 hover:underline">View Log</a>
                </td>
              </tr>
            </tbody>
          </table>
