...
<template>
  <div class="flex justify-center items-center min-h-[86vh] bg-yellow-50">
    <div class="max-w-xl w-full p-10 bg-white border border-gray-400/20 shadow-md rounded-2xl m-5 sm:10 text-gray-800">
      <div class="mb-4">
          ...
          <div class="space-y-2">
            ...
            <div class="flex gap-2">
              <div class="flex items-center">
                <input type="radio" name="status" value="delivered" v-model="status" class="w-4 h-4" required />
                <label class="ml-2 font-medium">Accept</label>
              </div>
              <div class="flex items-center">
                <input type="radio" name="status" value="cancelled" v-model="status" class="w-4 h-4" required />
