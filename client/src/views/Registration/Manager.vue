...
<template>
  <div class="flex justify-center items-center">
    <div
      class="max-w-2xl w-full p-10 bg-white border border-gray-400/20 shadow-md rounded-2xl text-gray-800"
    >
      <div class="mb-4">
        <div class="font-semibold text-2xl text-yellow-700">
          Manager Registration
        </div>
        <div class="text-gray-500 text-sm">Register a Manager.</div>
      </div>
