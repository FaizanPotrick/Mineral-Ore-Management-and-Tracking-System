      ...
      <form class="space-y-5 drop-shadow-md" @submit.prevent="register_fn()">
        <div class="grid gap-6 grid-cols-1">
          <div class="space-y-2">
            ...
            <input type="text"
              ...
              placeholder="Organization ID" v-model="useMineStore().organization_id" required id="org_id"
              list="org_id_list" />
        ...
        <div class="grid gap-6 sm:grid-cols-2">
          ...
          <div class="space-y-2">
            ...
            <input type="text"
              class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
              placeholder="Aadhar Card" @change="useValidationStore().validation(manager_aadhar_card)"
