    ...
    >
      <div class="mb-4">
        ...
        <span
          ...
          v-if="useAlertStore().alert_text.isAlert"
      ...
      <form class="space-y-5 drop-shadow-md" @submit.prevent="register_fn()">
        <div class="grid gap-6 grid-cols-1">
          <div class="space-y-2">
            ...
            <input
              ...
              v-model="useMineStore().organization_id"
              required
              id="org_id"
              list="org_id_list"
            />
          ...
          <div class="space-y-2">
            ...
            <input
              ...
              @change="useValidationStore().validation(manager_name)"
              v-model="manager_name.value"
              maxlength="150"
              required
            />
            <span
              class="text-center text-sm text-red-500"
              v-if="!manager_name.valid"
              >{{ manager_name.message }}</span
            >
          </div>
        </div>
        <div class="grid gap-6 sm:grid-cols-2">
          <div class="space-y-2">
            ...
            <input
              ...
              @change="useValidationStore().validation(manager_email_address)"
              v-model="manager_email_address.value"
              maxlength="150"
              required
            />
            <span
              class="text-center text-sm text-red-500"
              v-if="!manager_email_address.valid"
              >{{ manager_email_address.message }}</span
            >
          </div>
          <div class="space-y-2">
            <label class="text-sm font-medium text-gray-700"
            ...
            <input
              ...
              @change="useValidationStore().validation(manager_phone_no)"
              v-model="manager_phone_no.value"
              minlength="10"
              maxlength="10"
              required
            />
            <span
              class="text-center text-sm text-red-500"
              v-if="!manager_phone_no.valid"
              >{{ manager_phone_no.message }}</span
            >
          </div>
          <div class="space-y-2">
            <label class="text-sm font-medium text-gray-700"
            ...
            <input
              ...
              @change="useValidationStore().validation(manager_aadhar_card)"
              v-model="manager_aadhar_card.value"
              minlength="12"
              maxlength="12"
              required
            />
            <span
              class="text-center text-sm text-red-500"
              v-if="!manager_aadhar_card.valid"
              >{{ manager_aadhar_card.message }}</span
            >
          </div>
        </div>
        <div class="grid gap-6 md:grid-cols-3 sm:grid-cols-2">
          <div class="space-y-2">
            ...
            <input
              ...
              class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
              @change="useValidationStore().validation(mine_pin_code)"
              v-model="mine_pin_code.value"
              required
            />
            <span
              class="text-center text-sm text-red-500"
              v-if="!mine_pin_code.valid"
              >{{ mine_pin_code.message }}</span
            >
          </div>
          <div class="space-y-2">
            <label class="text-sm font-medium text-gray-700"
            ...
            <input
              type="number"
              class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
              @change="useValidationStore().validation(mine_area)"
              v-model="mine_area.value"
              required
            />
            <span
              class="text-center text-sm text-red-500"
              v-if="!mine_area.valid"
              >{{ mine_area.message }}</span
            >
          </div>
          <div class="space-y-2">
            <label class="text-sm font-medium text-gray-700"
            ...
            <input
              type="number"
              class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
              @change="useValidationStore().validation(mine_warehouse_capacity)"
              v-model="mine_warehouse_capacity.value"
              required
            />
            <span
              class="text-center text-sm text-red-500"
              v-if="!mine_warehouse_capacity.valid"
              >{{ mine_warehouse_capacity.message }}</span
            >
          </div>
          <div class="space-y-2">
            <label class="text-sm font-medium text-gray-700"
            ...
            <input
              type="number"
              class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
              @change="useValidationStore().validation(lease_period)"
              v-model="lease_period.value"
              required
            />
            <span
              class="text-center text-sm text-red-500"
              v-if="!lease_period.valid"
              >{{ lease_period.message }}</span
            >
          </div>
        </div>
        <hr />
        <div class="font-semibold text-md">Geological Survey Details</div>
        <div class="space-y-2">
          <label class="text-md font-medium text-gray-700"
            >Upload Geological File*</label
          >
          <input
            class="w-full content-center text-base border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
            @change="oresStore.preview_document"
            type="file"
        ...
        <div class="space-y-2">
          <label class="text-sm font-medium text-gray-700"
            >Approximate Amount Of Iron Ore Present*</label
          >
          <input
            type="text"
        ...
        <hr />
        <GMapMap
          :center="useMineStore().center"
          :zoom="useMineStore().zoom"
          map-type-id="terrain"
          style="width: 100%; height: 50vh"
          @click="marker_selector"
        >
          <GMapMarker
            v-if="
