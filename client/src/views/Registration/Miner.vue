            ...
            <form class="space-y-5 drop-shadow-md" @submit.prevent="register_fn()">
                <div class="grid gap-6 grid-cols-1">
                    ...
                    <div class="space-y-2">
                        ...
                        <span class="text-center text-sm text-red-500" v-if="!manager_name.valid">{{
                ...
                <div class="grid gap-6 sm:grid-cols-2">
                    <div class="space-y-2">
                        <label class="text-sm font-medium text-gray-700">Manager Email
                            Address*</label>
                        <input type="email"
                            class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
                    ...
                    <div class="space-y-2">
                        <label class="text-sm font-medium text-gray-700">Manager Phone
                            No.*</label>
                        <input type="text"
                            class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
                        ...
                        <span class="text-center text-sm text-red-500" v-if="!manager_phone_no.valid">{{
                                manager_phone_no.message
                        }}</span>
                    </div>
                    <div class="space-y-2">
                ...
                <div class="grid gap-6 md:grid-cols-3 sm:grid-cols-2">
                    <div class="space-y-2">
                        ...
                        <select
                            class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
                            v-model="useMinerStore().mine_state" required>
                    ...
                    <div class="space-y-2">
                        ...
                        <select
                            class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
                            v-model="useMinerStore().mine_district" required>
                    ...
                    <div class="space-y-2">
                        ...
                        <select
                            class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
                            v-model="useMinerStore().mine_pin_code" required>
                    ...
                    <div class="space-y-2">
                        ...
                        <span class="text-center text-sm text-red-500" v-if="!mine_area.valid">{{
                                mine_area.message
                        }}</span>
                    </div>
                    <div class="space-y-2">
                        ...
                        <input type="number"
                            ...
                            v-model="mine_warehouse_capacity.value" required>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number"
                            class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
                            @change="useValidationStore().validation(lease_period)" v-model="lease_period.value"
                            required>
                        <span class="text-center text-sm text-red-500" v-if="!lease_period.valid">{{
                                lease_period.message
                        }}</span>
                    </div>
                </div>
