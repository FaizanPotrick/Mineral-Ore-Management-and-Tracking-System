...
<template>
  <div class="flex justify-center items-center">
    <div
      class="max-w-4xl p-10 bg-white border border-gray-400/20 shadow-md rounded-2xl text-gray-800"
    >
      <div class="mb-4">
      ...
      <form class="space-y-5 drop-shadow-md" @submit.prevent="register_fn()">
        ...
        <div class="grid gap-6 md:grid-cols-3 sm:grid-cols-2">
          <div class="space-y-2">
            ...
            <select
              class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
              v-model="useMinerStore().mine_state"
              required
            >
          ...
          <div class="space-y-2">
            ...
            <select
              class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
              v-model="useMinerStore().mine_district"
              required
            >
          ...
          <div class="space-y-2">
            ...
            <select
              class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
              v-model="useMinerStore().mine_pin_code"
              required
            >
              <option disabled selected value="">Choose a Pin code</option>
              <option value="US">United States</option>
              <option value="CA">Canada</option>
              <option value="FR">France</option>
              <option value="DE">Germany</option>
