    ...
    <div class="flex justify-center items-center">
        <div class="max-w-4xl p-10 bg-white border border-gray-400/20 shadow-md rounded-2xl text-gray-800">
            <div class="mb-4">
                ...
                <div class="text-gray-500 text-sm">Register a officer account.</div>
                <span
            ...
            <form class="space-y-5 drop-shadow-md" @submit.prevent="register_fn()">
                <div class="grid gap-6 mb-6 grid-cols-1">
                    <div class="space-y-2">
                        ...
                        <span class="text-center text-sm text-red-500" v-if="!officer_name.valid">{{
                                officer_name.message
                        }}</span>
                    </div>
                </div>
                <div class="grid gap-6 sm:grid-cols-2">
                    <div class="space-y-2">
                        <label class="text-sm font-medium text-gray-700">Officer Email
                            Address*</label>
                        <input type="email"
                            class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
                    ...
                    <div class="space-y-2">
                        <label class="text-sm font-medium text-gray-700">Officer Phone
                            No.*</label>
                        <input type="text"
                            class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
                        ...
                        <span class="text-center text-sm text-red-500" v-if="!officer_phone_no.valid">{{
                                officer_phone_no.message
                        }}</span>
                    </div>
                    <div class="space-y-2">
                    ...
                    <div class="space-y-2">
                        ...
                        <select
                            class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
                            v-model="useOfficerStore().region_name" required>
