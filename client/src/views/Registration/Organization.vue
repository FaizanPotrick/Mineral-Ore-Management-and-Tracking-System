        ...
        <div class="grid gap-6 mb-6 grid-cols-1">
          <div class="space-y-2">
            ...
            <input
              ...
              v-model="organization_name.value"
              maxlength="300"
              required
            />
            <span
              class="text-center text-sm text-red-500"
              v-if="!organization_name.valid"
              >{{ organization_name.message }}</span
            >
          </div>
          <div class="space-y-2">
            ...
            <input
              ...
              class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
              placeholder="Address"
              @change="useValidationStore().validation(address)"
          ...
          <div class="space-y-2">
            ...
            <input
              ...
              @change="useValidationStore().validation(ceo_name)"
              v-model="ceo_name.value"
              maxlength="150"
              required
            />
            <span
        ...
        <div class="grid gap-6 sm:grid-cols-2">
          <div class="space-y-2">
            ...
            <input
              ...
              v-model="ceo_email_address.value"
              maxlength="150"
              required
            />
            <span
              class="text-center text-sm text-red-500"
              v-if="!ceo_email_address.valid"
              >{{ ceo_email_address.message }}</span
            >
          </div>
          <div class="space-y-2">
            <label class="text-sm font-medium text-gray-700"
            ...
            <input
              ...
              @change="useValidationStore().validation(ceo_phone_no)"
              v-model="ceo_phone_no.value"
              minlength="10"
              maxlength="10"
              required
            />
            <span
              class="text-center text-sm text-red-500"
              v-if="!ceo_phone_no.valid"
              >{{ ceo_phone_no.message }}</span
            >
          </div>
          <div class="space-y-2">
            <label class="text-sm font-medium text-gray-700"
              >CEO Aadhar Card*</label
            >
            <input
              type="text"
              class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
            ...
            <span
              class="text-center text-sm text-red-500"
              v-if="!ceo_aadhar_card.valid"
              >{{ ceo_aadhar_card.message }}</span
            >
          </div>
          <div class="space-y-2">
            ...
            <input
              ...
              @change="useValidationStore().validation(gst_no)"
              v-model="gst_no.value"
              minlength="15"
              maxlength="15"
              required
            />
