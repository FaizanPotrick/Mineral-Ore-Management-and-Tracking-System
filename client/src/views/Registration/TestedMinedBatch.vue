    ...
    >
      ...
      <form class="space-y-5 drop-shadow-md" @submit.prevent="register_fn()">
        <div class="grid gap-6 mb-6 sm:grid-cols-2">
          ...
          <input
            class="w-full px-3 py-1.5 border rounded-lg focus:outline-none focus:border-yellow-600/40"
            v-model="tested_mined_batch.fe_percentage"
            type="text"
            placeholder="Grade(Fe%)"
            pattern="[0-9]+"
            required
          />
          <input
            class="w-full px-3 py-1.5 border rounded-lg focus:outline-none focus:border-yellow-600/40"
            v-model="tested_mined_batch.quantity"
            type="text"
          ...
          <input
            class="w-full px-3 py-1.5 border rounded-lg focus:outline-none focus:border-yellow-600/40"
            v-model="tested_mined_batch.waste"
            type="text"
            placeholder="Waste(in mt)"
            pattern="[0-9]+"
            required
          />
        </div>
