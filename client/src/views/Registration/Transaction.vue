...
const invoice_document = (event) => {
  transaction.value.invoice = event.target.files[0];
};
      ...
      <form class="space-y-5 drop-shadow-md" @submit.prevent="register_fn()" enctype="multipart/form-data">
        <div class="grid gap-6 grid-cols-1">
          <div class="space-y-2">
            ...
            <input type="text"
              ...
              placeholder="Organization ID" v-model="transaction.organisation_id" required list="org_id_list" />
        ...
        <div class="grid gap-6 mb-6 sm:grid-cols-2">
          <div class="space-y-2">
            ...
            <select
              ...
              v-model="transaction.type_of_ore" required>
        ...
        <div class="grid gap-6 mb-6 sm:grid-cols-2">
          <div class="space-y-2">
            ...
            <input
              class="w-full content-center text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
              v-model="transaction.quantity" type="number" pattern="[0-9]+" required />
          </div>
          <div class="space-y-2">
