<script setup>
import useTansactionStore from "@/stores/TransactionsStore";
...
onMounted(async () => {
    ...
    useTansactionStore().organisations = data.organisations;
});
</script>
<template>
    <div class="flex justify-center items-center min-h-[86vh] bg-yellow-50">
        <div class="max-w-4xl p-10 bg-white border border-gray-400/20 shadow-md rounded-2xl m-5 sm:10 text-gray-800">
            <div class="mb-4">
                ...
                <div class="text-gray-500 text-sm">Register a transaction.</div>
                <span class="text-red-500 text-center text-sm" v-if="useAlertStore().alert_text.isAlert">{{
                        useAlertStore().alert_text.message
                }}</span>
            </div>
            <form class="space-y-5 drop-shadow-md" @submit.prevent="useTansactionStore().transaction_register_fn()"
                ...
                <div class="grid gap-6 grid-cols-1">
                    <div class="space-y-2">
                        ...
                        <input type="text"
                            ...
                            placeholder="Organization ID" v-model="useTansactionStore().organisation_id" required
                            list="org_id_list" />
                        <datalist id="org_id_list">
                            <option :value="organisation._id"
                                v-for="organisation of useTansactionStore().organisations">
                ...
                <div class="grid gap-6 mb-6 sm:grid-cols-2">
                    <div class="space-y-2">
                        ...
                        <select
                            ...
                            v-model="useTansactionStore().type_of_ore" required>
                    ...
                    <div class="space-y-2">
                        ...
                        <input
                            class="w-full content-center text-base px-4 py-2 border  border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
                            v-model="useTansactionStore().fe_percentage" type="number" required>
                    </div>
                </div>
                <div class="grid gap-6 mb-6 sm:grid-cols-2">
                    <div class="space-y-2">
                        ...
                        <input
                            class="w-full content-center text-base px-4 py-2 border  border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
                            v-model="useTansactionStore().quantity" type="number" required>
                    ...
                    <div class="space-y-2">
                        ...
                        <input
                            class="w-full content-center text-base px-4 py-2 border  border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
                            v-model="useTansactionStore().price" type="number" required>
                ...
                <div class="grid gap-6 mb-6 grid-cols-1">
                    <div class="space-y-2">
                        ...
                        <input
                            ...
                            @change="useTansactionStore().invoice_document" type="file" accept="application/pdf"
                            required>
                    </div>
                </div>
