  ...
  <div class="flex justify-center items-center min-h-[86vh]">
    ...
    >
      <div class="mb-4">
        ...
        <div class="text-gray-500 text-sm">Add weight details (In MetricTons).</div>
      </div>
        ...
        <div class="grid gap-6 mb-6 grid-cols-1">
          <div class="space-y-2">
            ...
            <input
              ...
              placeholder="Total Weight (In Metric Tons)"
          ...
          <div class="space-y-2">
            <label class="text-sm font-medium text-gray-700">Add Remarks</label>
            <input
              type="stri"
              class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-yellow-600"
