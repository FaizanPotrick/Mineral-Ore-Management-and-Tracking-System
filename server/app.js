...
app.use(require("./routes/User/Officer.js"));
app.use(require("./routes/User/Organisation.js"));
app.use(require("./routes/User/Miner.js"));
app.use(require("./routes/User/Warehouse.js"));
app.use(require("./routes/User/Checkpoint.js"));
app.use(require("./routes/User/Lab.js"));
app.use(require("./routes/Dashboard/Officer/Country.js"));
app.use(require("./routes/Dashboard/Officer/State.js"));
app.use(require("./routes/Dashboard/Officer/District.js"));
app.use(require("./routes/Dashboard/Organisation.js"));
app.use(require("./routes/Dashboard/Miner.js"));
app.use(require("./routes/Dashboard/Checkpoint.js"));
app.use(require("./routes/Dashboard/Lab.js"));
