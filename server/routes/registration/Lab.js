...
const CheckPoint = require("../../models/LabSchema");
  ...
  async (req, res, next) => {
    ...
    try {
      ...
      await Promise.all([
        ...
        CheckPoint.create({
          checkpoint_officer_id: lab_officer_id,
          region_id: _id,
          coordinates: coordinates,
        }),
      ]);
      req.user_id = lab_officer_id;
      req.user_name = name;
      req.user_type = "Lab Manager";
    ...
    async (req, res, next) => {
        ...
        const documentRef = ref(
          ...
          const batch_lab_report_path = await uploadBytes(
            ...
            const batch_lab_report_url_signed = await getSignedUrl(batch_lab_report_path);
